...
|---|---|
| **Logical Reasoning** | Pattern recognition, deductive and inductive reasoning, sequencing |
| **Quantitative Thinking** | Numerical aptitude, spatial reasoning, data interpretation |
